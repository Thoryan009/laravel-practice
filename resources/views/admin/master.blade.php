...
<nav id="navbar-main" class="navbar is-fixed-top">
  ...
  <div class="navbar-menu" id="navbar-menu">
    <div class="navbar-end">
      ...
      <a title="Log out" class="navbar-item desktop-icon-only" onclick="event.preventDefault(); document.getElementById('logoutForm').submit()">
        <span class="icon"><i class="mdi mdi-logout"></i></span>
        <span>Log out</span>
      </a>
...
<footer class="footer">
  <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0">
    <div class="flex items-center justify-start space-x-3">
      ...
      <div>
        <p class="hover:text-blue">Distributed By: <a href="https://webcoder-it.com/" target="_blank">Webcoder-IT Institute</a></p>
      </div>
...
<script type="text/javascript" src="{{asset('/')}}admin_asset/js/chart.sample.min.js"></script>
